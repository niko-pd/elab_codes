...
gfortran -Wall -Wextra -Wconversion -pedantic -O -fcheck=all -g -fbacktrace -ffpe-trap=zero,overflow,underflow,invalid -ffree-line-length-none 5-maps.f90 -o 5-maps.x
...
do
	...
	echo "$vel $dt $min $displacement $ly $ny $exclude_period" | ../../5-maps.x #&
	#sleep 20
